    ...
    <section id="berita">
        <div class="container">
            ...
            <div x-data="{id:'',title:'',body:'',time:'',image:'',show:'false'}">
                ...
                <div class="card-box">
                    ...
                    <div x-bind:class="id == {{ $item['id']}} ? ' bg-white shadow-xl border'  : 'bg-white shadow border'" class="card relative">
                        ...
                        <div class="text">
                            ...
                            <button x-on:click="id='{{ $item['id'] }}',body = '{{$item['body']}}',title = '{{$item['title']}}',image = '{{$item['image']}}',time = '{{$item['updated_at']}}',show='true'"  onclick="window.location.href='#bacaberita'" class="absolute bottom-2">Continue Reading</button>
                        </div>
                    </div>
                    @endforeach
                ...
                <div x-show="show == 'true'" class="card mb-8 md:mx-2 lg:mx-4 rounded-xl bg-white border shadow-xl" id="bacaberita">
    ...
    <section id="pengumuman">
        <div class="container">
            ...
            <div x-data="{id:'',title:'',body:'',time:'',show:'0'}" class="w-full flex justify-center flex-col gap-4">
                <div class="w-full flex justify-center">
                    <div x-show="show == '1'" x-bind:class="show == 1? 'card border-4 border-blue-700' : 'hiden'">
